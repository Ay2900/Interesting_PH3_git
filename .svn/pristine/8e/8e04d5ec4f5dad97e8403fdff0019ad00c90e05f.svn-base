...
CREATE TABLE `designer_table`  (
  ...
  `designer_motto` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '“关于未来，我有许多计划，但其中重要的是，与榆杨合作成功。”' COMMENT '设计师座右铭',
...
CREATE TABLE `shopping_car_item_table`  (
  ...
  `SKU_code` int(8) NOT NULL COMMENT 'SKU编码',
  `shopping_car_id` int(11) NOT NULL COMMENT '购物车id',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'SKU表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'SPU表' ROW_FORMAT = Dynamic;
